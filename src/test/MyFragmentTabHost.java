/**
 * Filename : MyFragmentTabHost.java Author : CX Date : 2013-9-6
 * 
...
/**
 * Special TabHost that allows the use of {@link Fragment} objects for its tab content. When placing
 * this in a view hierarchy, after inflating the hierarchy you must call
 * {@link #setup(Context, FragmentManager, int)} to complete the initialization of the tab host.
 * 
 */
